...
> 数据源:`data/rollout-traj/<部门>-<难度>.jsonl`(39 文件 × 500 玩家,rollout v4 终版数据:hard 成本系数 1.2;easy/normal 与 v3 逐组合零变化,mock LLM 口径)。每个 Demo 精选 2 名玩家做全景展示,并提供 24 步完整轨迹表、原文样例与本部门 1,500 人统计。
