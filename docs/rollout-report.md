...
| 场景 | 并发 | 吞吐 | p50 | p99 | 错误 |
|---|---|---|---|---|---|
| S1 静态首页 | 200×20s | 467,395 req | 8ms | 18ms | **0** |
| S2 静态三件套 | 200×20s | 143,262 req | 26ms | 60ms | **0** |
| S3 真实用户API流水线 | 200×20s | 44,892 rps | 1.1ms | 16.8ms | **0** |
| S4 峰值脉冲 | 500×10s | 32,264 rps | 1.1ms | 9.4ms | **0** |
