...
从存储的原始 JSONL 轨迹全量重算(不信任运行时计数)。两套口径最终一致:
...
| 4. 职级事实 | 引擎修正后残留 | **0** |
| | 非法职级跳变 | **0**(职级只经晋升 +1) |
| 5. 晋升喜悦 | 晋升步 | 58,223 步(12.4%),见下方分布 |
...
- mixed 玩家 99.3% GREAT/GOOD;random 玩家 68% GREAT / 23% GOOD / 8% MID/BAD
...
4. 游戏平衡:easy 下 good/mixed 中盘属性顶格(219/500 人第 12-24 步四维全满)、
